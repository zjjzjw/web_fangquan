define(['zepto'], function ($) {
    ...
    Area.prototype.selectedId = function (first, second, third) {
        ...
        $(self.opts.idNames[0]).val(first).attr('selected', true);
        self.change($(self.opts.idNames[0]).val(), $(self.opts.idNames[0]));
        $(self.opts.idNames[1]).val(second).attr('selected', true);
    };
