$(function () {
    ...
    var service = require('../../../service/developer/developerProjectContactService');
        ...
        if (parseInt($.params.id) == 0) {
            ...
            service.store({
                ...
                sucFn: function (data, status, xhr) {
                    ...
                    function skipUpdate() {
                        $successPop.closePop();
                        window.location.href = '/developer/'+$.params.developer_project_id+'/developer-project-contact/index';
                    }
                },
