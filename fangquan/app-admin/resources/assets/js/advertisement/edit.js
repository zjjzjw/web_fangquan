$(function () {
    ...
    var service = require('../../service/advertisement/advertisementService');
    ...
    function moreValidate() {
        var logo = $('.picture-box-image .show-item').length;
        if (logo < 1) {
            ...
            service.store({
                ...
                sucFn: function (data, status, xhr) {
                    ...
                    function skipUpdate() {
                        $successPop.closePop();
                        window.location.href = '/advertisement/advertisement/index';
                    }
                },
