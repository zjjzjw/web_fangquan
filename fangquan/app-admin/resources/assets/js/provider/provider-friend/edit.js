$(function () {
    ...
    var service = require('../../../service/provider/providerFriendService');
    ...
    function moreValidate() {
        var image_id = $('.picture-box-logo .show-item').length;
        ...
        if(!reg.test(url)){
            ...
            service.store({
                ...
                sucFn: function (data, status, xhr) {
                    ...
                    function skipUpdate() {
                        $successPop.closePop();
                        window.location.href = '/provider/' + $.params.provider_id + '/provider-friend/index';
                    }
                },
