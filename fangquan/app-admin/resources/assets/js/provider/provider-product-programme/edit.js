$(function () {
    ...
    var service = require('../../../service/provider/providerProductProgrammeService');
    ...
    function moreValidate() {
        var provider_product_programme_images = $('.picture-box-provider_product_programme_images .show-item').length;
        if (provider_product_programme_images < 1) {
            ...
            service.store({
                ...
                sucFn: function (data, status, xhr) {
                    ...
                    function skipUpdate() {
                        $successPop.closePop();
                        window.location.href = '/provider/' + $.params.provider_id + '/provider-product-programme/index';
                    }
                },
    ...
    fileupload({
        ...
        dom: $('#addPicture-provider_product_programme_images'),
        ...
        callback: function (result, data) {
            ...
            $('.add-provider_product_programme_images').before(tempFiles);
            $('.add-provider_product_programme_images').css('border-color', '#d9d9d9');

            //图片删除
            $('.picture-box-provider_product_programme_images .show-item').on('click', '.delete', function () {
                $(this).parent('.show-item').remove();
                $('.add-provider_product_programme_images').show();
            });
        }
    });
