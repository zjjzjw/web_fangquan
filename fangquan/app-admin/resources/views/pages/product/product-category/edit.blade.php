        ...
        <div id="contain">
            ...
            <form id="form" onsubmit="return false">
                            ...
                            <ul class="product-attribute-list">
                                @if(!empty($attribfield_light))
                                    ...
                                    @foreach($attribfield_light ?? [] as $key => $attribfield_light_item)
                                        ...
                                        <input type="hidden" name="product[category-param-name][]"
                                               value="{{$attribfield_light_item['name'] or ''}}">
                                        <input type="hidden" name="product[category-param-key][]"
                                        ...
                                        @foreach($attribfield_light_item['nodes'] ?? [] as $node)
                                            <li class="{{$attribfield_light_item['name'] or '' }}">
                                                ...
                                                <input type="hidden"
                                                       name="product[category-param{{$index}}][param-name][]"
                                                       data-index="{{$index}}" value="{{$node['name'] or ''}}">
                                                <input type="hidden"
                                                       name="product[category-param{{$index}}][param-key][]"
                ...
                <div class="row">
                    <div class="columns">
                        <label>icon：</label>
                        <input class="rank" type="text" name="icon" value="{{ $icon or '' }}"/>
                    </div>
                </div>
