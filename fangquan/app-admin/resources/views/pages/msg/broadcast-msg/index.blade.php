    ...
    <div class="wrapper-box">
        <div class="content-box">
            ...
            <div class="button-box">
                <div class="add-btn">
                    <a href="{{route('msg.broadcast-msg.send', ['id' => $id ?? 0])}}"
                       class="button">+ 发送消息</a>
                </div>
            </div>
                ...
                <table class="table" cellspacing="0" cellpadding="0">
                    ...
                    @foreach($items ?? [] as $item)
                        <tr>
                            ...
                            <td>{{$item['mag_type_name'] or  ''}}</td>
                            <td>{{$item['created_at'] or ''}}</td>
                            <td>
                                <a title="详情" class="icon-edit"   href="{{route('msg.broadcast-msg.send',['id'=> $item['id'] ])}}">
                                    <i class="iconfont">&#xe61b;</i>
                                </a>
