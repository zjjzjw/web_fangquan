                ...
                <form method="GET" action="" id="" onsubmit="return false">
                        ...
                        <div class="small-8 columns">
                            ...
                            <div class="small-14 columns">
                                <select name="status">
                                    ...
                                    @foreach($provider_product_programme_status as $key => $name)
                                        <option value="{{$key}}"
                    ...
                    <div class="row">
                        <div class="columns">
                            ...
                            <a href="{{route('provider.provider-product-programme.list')}}" class="button reset-btn">重置</a>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <table class="table" cellspacing="0" cellpadding="0">
                    ...
                    @foreach(($items ?? [] ) as $item)
                        <tr>
                            ...
                            <td>
                                <a title="详情" class="icon-edit"   href="{{route('provider.provider-product-programme.audit',['id'=> $item['id'] ])}}">
                                    <i class="iconfont">&#xe61b;</i>
                                </a>
