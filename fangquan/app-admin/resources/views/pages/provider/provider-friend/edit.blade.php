    ...
    <div class="wrapper-box">
        ...
        <div class="content-box">
            <div class="button-box">
                @if(empty($id))
                    <p class="top-title">战略合作商添加</p>
                @else
                    <p class="top-title">战略合作商编辑</p>
                @endif
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="small-14 columns">
                            <input type="text" name="name" value="{{$name or ''}}"
                                   ...
                                   data-validation-error-msg="请添加开发商名称"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="small-14 columns">
                            <div class="img-box">
                                ...
                                <p class="error-tip-imageId error-tip" style="display: none;">请上传Logo</p>
                            </div>
                        </div>
                    </div>
