...
class  ProviderBrandStoreForm extends Form
{
    ...
    public function validation()
    {
        ...
        $provider_pictures = [];
        $provider_entity->patent_count = array_get($this->data, 'patent_count') ?? 0;
        ...
        if ($patent_images = array_get($this->data, 'patent_image')) {
            foreach ($patent_images as $patent_image) {
                $provider_pictures[] = ['type' => ProviderImageType::PATENT, 'image_id' => $patent_image];
            }
        }
